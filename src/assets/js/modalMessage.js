export function modalMessage({ message, isWarning }) {
  ...
  if (isWarning) {
    ...
    closeElement.classList.add("btn", "btn--theme", "modal__btn");
    closeElement.textContent = "X";
    
    
    closeElement.addEventListener("click", (e)=> {
      e.preventDefault();
      modalElement.classList.remove("modal--animate-warning");
      modalElement.classList.add("modal--animate-warning-reverse");
